...
(function () {
  var TX = {
    ...
    "tut.step3_title": { en: "Member Strip & Check-in", es: "Tira de Miembros y Registro" },
    "tut.step3_text":  { en: "See who's in the lab at a glance. <strong>Green dot</strong> = free, <strong>orange dot</strong> = busy on a job, <strong>grayed out</strong> = not checked in. Click the <strong>Check in</strong> button in the top bar to toggle your status — your busy/free state is inferred from your active cards.",
    ...
    "tut.step4_title": { en: "Creating a Card", es: "Creando una Tarjeta" },
    "tut.step4_text":  { en: "Click <strong>Add task</strong> at the bottom of any column to open the creation form. Fill in the <strong>owner</strong>, <strong>title</strong>, and <strong>description</strong> (required), then optionally pick a <strong>machine type</strong> and <strong>priority</strong>. Press <strong>Ctrl+Enter</strong> or click Create. The card lands in that column.",
    ...
    "tut.step5_title": { en: "Moving Cards", es: "Moviendo Tarjetas" },
    "tut.step5_text":  { en: "<strong>Drag</strong> any card and drop it into another column to move it. Prefer the keyboard? Press <strong>Tab</strong> to select a card, then use <strong>←</strong> and <strong>→</strong> arrow keys to move it left or right one column. <strong>Enter</strong> opens the selected card for editing.",
    ...
    "tut.step6_title": { en: "Claim & Start", es: "Tomar y Empezar" },
    "tut.step6_text":  { en: "See a Ready card you want to work on? Click the orange <strong>Claim &amp; start</strong> button — it <strong>assigns the card to you</strong>, moves it to In Progress, and <strong>starts the timer</strong> from zero. If nobody is checked in, it picks the first available member.",
    ...
    "tut.step7_title": { en: "The Screensaver", es: "El Salvapantallas" },
    "tut.step7_text":  { en: "After a few idle minutes the screen switches to a <strong>live dashboard</strong> with four big stats, active jobs with progress bars, member presence, and today's completed tasks. <strong>Press any key or click</strong> to return. You can also preview it anytime with the monitor button in the top bar.",
